...
const PopularCard = ({ imgURL, name, price }) => {
    return (
        <div className='mdl:w-[230px] flex flex-col w-[270px] h-[400px] border-0 border-brown-400 shadow-lg rounded-sm pb-4 hover:scale-110 mds:w-[300px] sml:w-[250px] sm-s:w-[230px] s:w-[400px] xs:min-w-[350px]' >
